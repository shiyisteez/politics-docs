...
document.addEventListener("DOMContentLoaded", function() {
  ...
  // Loop through each panel title and ensure the corresponding panel is expanded
  panelTitles.forEach(function(panelTitle) {
    var panel = panelTitle.nextElementSibling;
    if (panel) {
      panel.style.display = 'block'; // Ensure all panels are shown
    }
  });
});
